...
running command...
$ newmannium (--version)
newmannium/0.0.7 darwin-arm64 node-v16.13.0
...
_See code: [dist/commands/collections.ts](https://github.com/compoze/newmannium/blob/v0.0.7/dist/commands/collections.ts)_
...
_See code: [dist/commands/run.ts](https://github.com/compoze/newmannium/blob/v0.0.7/dist/commands/run.ts)_
<!-- commandsstop -->
* [`newmannium run`](#newmannium-run)
* [`newmannium collections`](#newmannium-collections)
